...
public class ColorButton extends Component {
    ...
    public ColorButton(Setting option, Button button, int offset) {
        this.op = option;
        this.parent = button;
    ...
    public void renderComponent(int mouseX, int mouseY) {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.op.getName(), (parent.parent.getX() + 7) , (parent.parent.getY() + offset + 2) + 5, -1);
        GL11.glPopMatrix();
        ...
        Gui.drawRect(parent.parent.getX() + parent.parent.getWidth() - 3, parent.parent.getY() + offset + 5, parent.parent.getX() + parent.parent.getWidth() - 14, parent.parent.getY() + offset + 15, op.getColor().getRGB());
    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        if(isMouseOnButton(mouseX, mouseY) && button == 0 && this.parent.open) {
            Minecraft.getMinecraft().displayGuiScreen(new ColorPicker(op));
        }
    }

...
public class Trajectories extends Module {
    ...
    public Trajectories() {
        super("Trajectories", "draw where projectile will fall", false, false, Category.Render);
    }
    ...
    public void onRenderWorldLast(RenderWorldLastEvent event) {
        if (this.isToggled()) {
            ...
            if (landingPosition != null && landingPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                rectBorder(-8.25f, -8.25f, 8.25f, 8.25f, 0x99ffffff);
                rect(-8.25f, -8.25f, 8.25f, 8.25f, 0x99ffffff);
            }
            GL11.glPopMatrix();
